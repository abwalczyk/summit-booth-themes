...
<section class="theme-page theme-cloud">
  ...
  <div class="demo-section">
    ...
    <a class="demo-card" href="https://app.arcade.software/share/oBoXzgiggcwGdG5DzosF?ref=share-link" target="_blank" rel="noopener">
      <div class="demo-card-media">
        <img src="{{ '/assets/images/automating_day_2_windows_vm_operations.png' | relative_url }}" width="800" height="450" alt="Automating Day 2 Windows VM operations — Red Hat Ansible Automation Platform" loading="lazy" />
      </div>
    ...
    <a class="demo-card" href="https://app.arcade.software/share/6eNZ8IFe6PiVOFyGIvHv?ref=share-link" target="_blank" rel="noopener">
      <div class="demo-card-media">
        <img src="{{ '/assets/images/network_automation_with_aap.png' | relative_url }}" width="800" height="450" alt="Network automation with AAP — Red Hat Ansible Automation Platform" loading="lazy" />
      </div>
